---
name: cos
description: Orchestrates COS specialists to produce strategic deliverables (PR-FAQ, buy-vs-build, PMF plans, tenets)
...
2. **Specialist Coordination**
   - Fan out tasks to specialists (PM, UX, PE, SDE-III, legal, finance, strategic-advisor)
...
3. **Staff specialists:** Assign based on type (see matrix below)
...
- Load `prfaq` skill
- Create `product/pr-faq.md`:
  - **Press Release:** "SparkryAI Launches AI Support Agent That Resolves 80% of Tickets Instantly"
