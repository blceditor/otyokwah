...
- REQ-012: AI-powered SEO generation (Claude API integration)
...
UNIVERSAL_LLM_KEY=<your_universal_llm_key>
# Get from: https://universal.sparkry.ai (your custom LLM router)
...
3. **Universal LLM Router Key**:
   ```bash
   # Already configured: UNIVERSAL_LLM_KEY
   # Endpoint: https://universal.sparkry.ai/v1/chat/completions
   # Model: "cost" (cheapest available router)
...
| Universal LLM costs excessive | Medium | Medium | Rate limiting (10/hour) + content truncation + "cost" model |
...
| Universal LLM Router | SEO generation | 10 req/hour (self-imposed) | User writes manually |
